...
| 5 | **Verified Standard IP — AXI4-Lite / TileLink** | Bus protocol interfaces with formal properties | Spec layer done — AXI protocol rules from ARM IHI 0022 Issue L formally verified (36 theorems, `Sparkle/Verification/AXIProps.lean`, see `docs/AXI_Spec_Map.md`); Signal DSL implementation TODO |
...
| **AXI4-Lite** | Spec verified | Protocol rules extracted from ARM IHI 0022 Issue L and machine-checked (`AXIProps.lean` + `docs/AXI_Spec_Map.md`); Signal DSL master/slave TODO |
