// BUG (seeded): handshake race — a new AWVALID arriving while the
// response is pending aborts it, dropping BVALID before BREADY.
// ============================================================================
    ...
    always_ff @(posedge clk) begin
        if (rst) begin
            ...
            if (!bvalid_q && both_done) begin
                ...
                bvalid_q <= 1'b1;
            end else if (bvalid_q && (bready || awvalid)) begin
                bvalid_q <= 1'b0;
                aw_done  <= 1'b0;
                w_done   <= 1'b0;
            end
