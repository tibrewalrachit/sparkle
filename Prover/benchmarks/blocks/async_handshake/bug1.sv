// BUG (seeded): 4-phase protocol race — the sender returns to IDLE
// without waiting for ack to go low, allowing a new transfer to change
// the held data while ack is still high.
// ============================================================================
