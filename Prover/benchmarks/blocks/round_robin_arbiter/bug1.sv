// BUG (seeded): rotation mask off-by-one — the mask includes the client
// granted last cycle (>= instead of >), breaking round-robin alternation.
// ============================================================================
...
module round_robin_arbiter (
    ...
    wire [3:0] gnt_masked   = masked_req & (~masked_req + 4'd1);
