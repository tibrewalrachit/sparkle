// BUG (seeded): the primitive feedback tap on bit 0 was dropped, so the
// state 16'h0001 shifts into the all-zero lockup state.
// ============================================================================
...
module lfsr (
    ...
    wire fb = lfsr_q[2] ^ lfsr_q[3] ^ lfsr_q[5];
